...
const DATA=${json};
const LIMIT=50;
let state={ageGroup:DATA.defaultAgeGroup,gender:DATA.defaultGender,selected:"",detail:{type:"none"},mobileDetail:false};
...
$("#teamDistributionBody").addEventListener("click",e=>{let t=e.target.closest("[data-team]");if(!t)return;state.selected="";state.detail={type:"team",team:t.dataset.team};state.mobileDetail=true;render();window.scrollTo({top:0,behavior:"smooth"})});
